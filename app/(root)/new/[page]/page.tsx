...
export default async function Page({
  ...
  return (
    <>
      <h2 className="sr-only">New Stories</h2>
...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${SITE_URL}/new/${page}`, // Canonical URL for this page
    },
    alternates: {
      canonical: `${SITE_URL}/new/${page}`, // Canonical URL
    },
  };
}
