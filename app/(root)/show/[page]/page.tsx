...
export default async function Page({
  ...
  return (
    <>
      <h2 className="sr-only">Show HN Stories</h2>
      <Suspense fallback={<StoriesListSkeleton />}>
        <Stories page={page} route="show" />
      </Suspense>
    </>
  );
}
...
export async function generateMetadata(
  ...
  const routeName = "Show HN Stories";
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${SITE_URL}/show/${page}`, // Canonical URL for this page
    },
    alternates: {
      canonical: `${SITE_URL}/show/${page}`, // Canonical URL
    },
  };
}
