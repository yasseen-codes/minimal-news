...
export default async function Page({
  ...
  return (
    <>
      <h2 className="sr-only">Ask HN Stories</h2>
      <Suspense fallback={<StoriesListSkeleton />}>
        <Stories page={page} route="ask" />
      </Suspense>
    </>
  );
}
...
export async function generateMetadata(
  ...
  const routeName = "Ask HN Stories";
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${SITE_URL}/ask/${page}`, // Canonical URL for this page
    },
    alternates: {
      canonical: `${SITE_URL}/ask/${page}`, // Canonical URL
    },
  };
}
